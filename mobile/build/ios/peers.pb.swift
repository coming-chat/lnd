...
enum Peersrpc_UpdateAction: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Peersrpc_UpdateAction] = [
    .add,
    .remove,
  ]
...
enum Peersrpc_FeatureSet: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Peersrpc_FeatureSet] = [
    .setInit,
    .setLegacyGlobal,
    .setNodeAnn,
    .setInvoice,
...
struct Peersrpc_UpdateAddressAction: Sendable {
...
struct Peersrpc_UpdateFeatureAction: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Peersrpc_NodeAnnouncementUpdateRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Peersrpc_NodeAnnouncementUpdateResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
