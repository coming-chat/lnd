...
enum Signrpc_SignMethod: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Signrpc_SignMethod] = [
    .witnessV0,
...
enum Signrpc_MuSig2Version: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  var rawValue: Int {
    ...
    case .v040: return 1
    case .v100Rc2: return 2
    case .UNRECOGNIZED(let i): return i
    }
  }

  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Signrpc_MuSig2Version] = [
    .undefined,
    .v040,
    .v100Rc2,
  ]
...
struct Signrpc_KeyLocator: Sendable {
...
struct Signrpc_KeyDescriptor: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_TxOut: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_SignDescriptor: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_SignReq: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_SignResp: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_InputScript: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_InputScriptResp: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_SignMessageReq: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var schnorrSigTapTweak: Data = Data()
...
struct Signrpc_SignMessageResp: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_VerifyMessageReq: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_VerifyMessageResp: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_SharedKeyRequest: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_SharedKeyResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_TweakDesc: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_TaprootTweakDesc: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_MuSig2CombineKeysRequest: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var version: Signrpc_MuSig2Version = .undefined
...
struct Signrpc_MuSig2CombineKeysResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_MuSig2SessionRequest: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  ///field.
  var pregeneratedLocalNonce: Data = Data()
...
struct Signrpc_MuSig2SessionResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_MuSig2RegisterNoncesRequest: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_MuSig2RegisterNoncesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_MuSig2SignRequest: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_MuSig2SignResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_MuSig2CombineSigRequest: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_MuSig2CombineSigResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_MuSig2CleanupRequest: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Signrpc_MuSig2CleanupResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Signrpc_MuSig2Version: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "MUSIG2_VERSION_UNDEFINED"),
    1: .same(proto: "MUSIG2_VERSION_V040"),
    2: .same(proto: "MUSIG2_VERSION_V100RC2"),
  ]
}
...
extension Signrpc_SignMessageReq: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    5: .standard(proto: "schnorr_sig"),
    6: .standard(proto: "schnorr_sig_tap_tweak"),
    7: .same(proto: "tag"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularBoolField(value: &self.schnorrSig) }()
      case 6: try { try decoder.decodeSingularBytesField(value: &self.schnorrSigTapTweak) }()
      case 7: try { try decoder.decodeSingularBytesField(value: &self.tag) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.schnorrSig != false {
      try visitor.visitSingularBoolField(value: self.schnorrSig, fieldNumber: 5)
    }
    if !self.schnorrSigTapTweak.isEmpty {
      try visitor.visitSingularBytesField(value: self.schnorrSigTapTweak, fieldNumber: 6)
    }
    if !self.tag.isEmpty {
      try visitor.visitSingularBytesField(value: self.tag, fieldNumber: 7)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Signrpc_SignMessageReq, rhs: Signrpc_SignMessageReq) -> Bool {
    ...
    if lhs.schnorrSig != rhs.schnorrSig {return false}
    if lhs.schnorrSigTapTweak != rhs.schnorrSigTapTweak {return false}
...
extension Signrpc_VerifyMessageReq: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .same(proto: "pubkey"),
    4: .standard(proto: "is_schnorr_sig"),
    5: .same(proto: "tag"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularBoolField(value: &self.isSchnorrSig) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.isSchnorrSig != false {
      try visitor.visitSingularBoolField(value: self.isSchnorrSig, fieldNumber: 4)
    }
    if !self.tag.isEmpty {
  ...
  static func ==(lhs: Signrpc_VerifyMessageReq, rhs: Signrpc_VerifyMessageReq) -> Bool {
    ...
    if lhs.isSchnorrSig != rhs.isSchnorrSig {return false}
    if lhs.tag != rhs.tag {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Signrpc_MuSig2CombineKeysRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularEnumField(value: &self.version) }()
      default: break
      }
    }
  }
...
extension Signrpc_MuSig2SessionRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    7: .standard(proto: "pregenerated_local_nonce"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try { try decoder.decodeSingularBytesField(value: &self.pregeneratedLocalNonce) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.pregeneratedLocalNonce.isEmpty {
      try visitor.visitSingularBytesField(value: self.pregeneratedLocalNonce, fieldNumber: 7)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Signrpc_MuSig2SessionRequest, rhs: Signrpc_MuSig2SessionRequest) -> Bool {
    ...
    if lhs._taprootTweak != rhs._taprootTweak {return false}
    if lhs.version != rhs.version {return false}
    if lhs.pregeneratedLocalNonce != rhs.pregeneratedLocalNonce {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
