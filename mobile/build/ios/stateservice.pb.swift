...
enum Lnrpc_WalletState: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Lnrpc_WalletState] = [
    .nonExisting,
    .locked,
    .unlocked,
    .rpcActive,
...
struct Lnrpc_SubscribeStateRequest: Sendable {
...
struct Lnrpc_SubscribeStateResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Lnrpc_GetStateRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Lnrpc_GetStateResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
